...
**Returns:** A `Promise<number[]>` containing the indices of points inside the rectangular area.
...
**Returns:** A `Promise<number[]>` containing the indices of points inside the polygon area.

### <a name="get_adjacent_indices" href="#get_adjacent_indices">#</a> graph.<b>getAdjacentIndices</b>(<i>pointIndices</i>)

Returns an array of point indices that are adjacent to the given point(s).

* **`pointIndices`** (Number | Number[]): A single point index or an array of point indices.

**Returns:** A unique `number[]` of adjacent point indices.

### <a name="get_adjacent_link_indices" href="#get_adjacent_link_indices">#</a> graph.<b>getAdjacentLinkIndices</b>(<i>pointIndices</i>)
