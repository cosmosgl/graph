...
| pointGreyoutOpacity | Opacity multiplier for greyed-out points when highlighting is active. When set, used instead of `pointOpacity` for greyed-out points. | `undefined` |
