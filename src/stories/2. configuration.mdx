...
| onRightClick | Called when a context menu trigger (typically right click) occurs on the canvas, with point index and position if exists |
| onPointRightClick | Called when a context menu trigger occurs on a point, with point index and position |
| onLinkRightClick | Called when a context menu trigger occurs on a link, with link index |
| onBackgroundRightClick | Called when a context menu trigger occurs on the background (empty space) |
