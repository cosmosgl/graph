...
export class ComputeManager {
  ...
  public constructor (config: ComputeManagerConfig) {
    this.config = config
  }
  ...
  public update (settings: ComputeSettings): void {
  ...
  public getPositionBuffer (): Buffer {
  ...
  public async readPositions (): Promise<Float32Array> {
